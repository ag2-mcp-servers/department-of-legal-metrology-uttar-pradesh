...
class CertificateParameters(BaseModel):
    applicationNo: str = Field(
        ..., description='Application No.', examples=['181527xxxxxxx7']
    )
    licenseNo: str = Field(..., description='License No.', examples=['53453xxxxxx11'])
...
class DelcsCertificatePostRequest(BaseModel):
...
class DelcsCertificatePostResponse(BaseModel):
...
class DelcsCertificatePostResponse1(BaseModel):
...
class DelcsCertificatePostResponse2(BaseModel):
...
class DelcsCertificatePostResponse3(BaseModel):
...
class DelcsCertificatePostResponse4(BaseModel):
...
class DelcsCertificatePostResponse5(BaseModel):
...
class DelcsCertificatePostResponse6(BaseModel):
...
class PalcsCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class PalcsCertificatePostResponse(BaseModel):
...
class PalcsCertificatePostResponse1(BaseModel):
...
class PalcsCertificatePostResponse2(BaseModel):
...
class PalcsCertificatePostResponse3(BaseModel):
...
class PalcsCertificatePostResponse4(BaseModel):
...
class PalcsCertificatePostResponse5(BaseModel):
...
class PalcsCertificatePostResponse6(BaseModel):
    error: Optional[Error20] = None
    errorDescription: Optional[ErrorDescription20] = None


class RelcsCertificatePostRequest(BaseModel):
    certificateParameters: Optional[CertificateParameters] = None
    consentArtifact: Optional[ConsentArtifactSchema] = None
    format: Format = Field(
        ..., description='The format of the certificate in response.'
...
class RelcsCertificatePostResponse(BaseModel):
...
class RelcsCertificatePostResponse1(BaseModel):
...
class RelcsCertificatePostResponse2(BaseModel):
...
class RelcsCertificatePostResponse3(BaseModel):
...
class RelcsCertificatePostResponse4(BaseModel):
...
class RelcsCertificatePostResponse5(BaseModel):
...
class RelcsCertificatePostResponse6(BaseModel):
